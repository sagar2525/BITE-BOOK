    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">BITE</span> <span class="clr-green">BOOK</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">BITE</span> <span class="clr-green md">BOOK</span></div>
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="index.html">Home</a></li>
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://vitbhopal.ac.in/" target="_blank">VIT Bhopla university</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91 6265XXXXXX</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>Developer@xyz.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Bhopal-Indore Highway
                            Kothrikalan, Sehore
                            Madhya Pradesh – 466114</p></li>
                        </ul>
                    </article>
            </section>
        `;
                ...
                <main class="grid grid-3">
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://vitbhopal.ac.in" target="_blank">VIT Bhopal</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            <h1 class="sm">Contact Information</h1>
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-6265XXXXXX</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>Developer@xyz</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Bhopal-Indore Highway
                            Kothrikalan, Sehore
                            Madhya Pradesh – 466114</p></li>
                        </ul>
...
const ordersInner = document.querySelector('.order-inner');
